  ...
  switch (action.type) {
    ...
    case TASKS_RESOLVED:
      return {
        ...
        taskConfig: {
          ...statePart.taskConfig,
          toUpdate: action.payload.toUpdate ? true : false,
          resolved: true,
          messages: action.payload.message.message.length
            ? [...statePart.taskConfig.messages, action.payload.message]
            : statePart.taskConfig.messages,
        },
      };
